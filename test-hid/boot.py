...
# https://github.com/dglaude/CircuitPython_udraw_Absolute_Mouse/blob/main/boot.py
absolute_mouse = usb_hid.Device(
    report_descriptor=bytes(
        ...
        + (
            0x15,
            0x00,
        )  # LOGICAL_MINIMUM (0)       ; Note: 0x15 = 1 Byte; 0x16 = 2 Byte; 0x17 = 4 Byte
        + (
            0x26,
            0xFF,
            0x7F,
        )  # LOGICAL_MAXIMUM (32767)   ; Note: 0x25 = 1 Byte, 0x26 = 2 Byte; 0x27 = 4 Byte Report
